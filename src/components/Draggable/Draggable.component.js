...
export class DraggableComponent extends PureComponent {
  ...
  handleDrag(e) {
    ...
    this.draggableRef.style.opacity = 0.5;
    e.dataTransfer.effectAllowed = "move";
    e.dataTransfer.setData("text/html", this.draggableRef);
  }

  handleDragEnd(e) {
    e.preventDefault();
    console.log(e.dataTransfer);
    this.draggableRef.style.opacity = 1;
  }

  handleDrop(e) {
    e.stopPropagation();
    this.draggableRef = e.dataTransfer.getData("text/html");
